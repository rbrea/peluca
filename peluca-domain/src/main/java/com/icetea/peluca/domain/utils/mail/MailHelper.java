package com.icetea.peluca.domain.utils.mail;
...
public class MailHelper {
	...
	public boolean send(final String emailTo, final String subject, final String text){
		...
		try {
			...
			throw new IdentifiableRuntimeException("Ha ocurrido un error al intentar enviar el email de reseteo de password. "
