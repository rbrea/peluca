CatalogueUpload = function(){}

CatalogueUpload.init = function(){
	...
	CatalogueService.reset();
	$("#btnSpSearch").click();
    })

    $('#modalImport').on('shown.bs.modal', function () { 
	$("#ruleSellPointResultTable").DataTable().destroy();
	RestConnector.PostFile('#ruleSellPointfileupload', '/app/service/catalogue/upload/xls/', '#ruleSellPointResult', '#ruleSellPoint_Result_Upload', '#rowSheet');
