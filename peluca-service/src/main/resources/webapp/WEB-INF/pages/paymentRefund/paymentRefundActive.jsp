...
<div id="modalPaymentRefundActiveAudited" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg auditoria">
		<div class="modal-content">
                  		<div class="modal-header">
                    		<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                  		...
                  		<div class="modal-body">
					   		...
					   		<div class="panel panel-default" id="auditedResult">
						            ...
						            <div class="panel-body">     
						                <div class="container-fluid">   
						                	<div class="table-responsive">  
						                      <table class="table" id="auditedPaymenRefundActiveTable">
						                          <thead>
						                            <tr>
						                            	<th><h4>Id</h4></th>
						                          ...
						                          <tbody id ="auditedPaymentRefundActiveTableBody">
...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i><span>Entidades Legales Cobro/Refund Activas</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<!-- Divider -->
		<span class="divider">/</span> <a href="#" class="bread-current">Entidades Legales Cobro/Refund Activas</a>
	</div>
...
<!-- Page heading ends -->
<div class="matter PAYMENT_REFUND">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="container">
						...
						<div class="col-md-12" style="text-align: center;">
							<div class="widget wgreen">
								...
								<div class="widget-head">
									<div class="pull-left">
										<form id="frmPaymentRefundExport" role="form" method="POST" enctype="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
										</form>
										<ul class="list-inline">
											<li>
												<i class="glyphicon glyphicon-th-list"></i>&nbsp;Entidades Legales Cobro/Refund Activas &nbsp;
											</li>
											<li>
											...
											<li>
												<button id="btnPaymentaRefundExport" class="btn btn-info btn-sm" title="Exportar">
											...
											<li>
											<button id="btnPaymentRefundRevisionAudited" class="btn btn-danger btn-sm roleable LECTURA" title="Auditoria">
									...
									<div class="widget-icons pull-right">
										...
										<button  id ="btnBackToEdit" onclick="location.href='${pageContext.request.contextPath}/app/html/payment-refund'" class="btn btn-warning btn-xs" title="Volver a Edicion">
												<i class="fa fa-reply-all"></i> ir a Edicion
										</button>

										<button  id ="btnBackToPending" onclick="location.href='${pageContext.request.contextPath}/app/html/payment-refund-pending'" class="btn btn-info btn-xs" title="Volver a Edicion">
...
<script src="${pageContext.request.contextPath}/app/public/js/app/service/rules/PaymentRefundActiveService.js"></script>
	...
	$(document).ready(
		function(){
			...
			$("#optPaymentRefund").addClass("current");
 			PaymentRefundActiveService.init();
...
<script id="rowSellTypeUniqueVersionSheet" type="text/x-handlebars-template">
    ...
    {{#each this}}
     <tr data-report = {{id}} class=" centered">
		...
		<td class='centered'><h4>{{dto.product_type}}</h4></td>
		<td class='centered'><h4>{{dto.country_code_site}}</h4></td>
		<td class='centered'><h4>{{dto.payment_method}}</h4></td> 
		<td class='centered'><h4>{{dto.collection_channel}}</h4></td> 
		<td class='centered'><h4>{{dto.merchant}}</h4></td> 
		<td class='centered'><h4>{{dto.legal_entity_description}}</h4></td>
     </tr>
    {{/each}}
</script>

<script id="rowPaymentRefundAuditedActiveSheet" type="text/x-handlebars-template">
