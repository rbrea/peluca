...
<head>
    ...
    <body class=" "><!-- START TOPBAR -->
            ...
            <div class='quick-area'>
                                ...
                                <li class="list">
                                    ...
                                    <ul class="dropdown-menu-list list-unstyled ps-scrollbar">
                                        <li class="unread status-available">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-1.png" alt="user-image" class="img-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-away">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-2.png" alt="user-image" class="img-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-busy">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-3.png" alt="user-image" class="img-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-offline">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-4.png" alt="user-image" class="img-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                                        ...
                                        <li class=" status-offline">
                                            <a href="javascript:;">
                                                <div class="user-img">
                                                    <img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-5.png" alt="user-image" class="img-circle img-inline">
                                                </div>
                                                <div>
                                                    <span class="name">
                ...
                <div class='pull-right'>
                    <ul class="info-menu right-links list-inline list-unstyled">
                        <li class="profile">
                            <a href="#" data-toggle="dropdown" class="toggle">
                                <img src="${pageContext.request.contextPath}/app/public/data/profile/profile.png" alt="user-image" class="img-circle img-inline">
                    ...
                    <div class="profile-info row">
                        ...
                        <div class="profile-image col-md-4 col-sm-4 col-xs-4">
                            <a href="ui-profile.html">
                                <img src="${pageContext.request.contextPath}/app/public/data/profile/profile.png" class="img-responsive img-circle">
                            </a>
                        </div>
                ...
                <div class="chat-wrapper">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="user-row" id='chat_user_1' data-user-id='1'>
                            <div class="user-img">
                                <a href="#"><img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-1.png" alt=""></a>
                            </div>
                            <div class="user-info">
                        ...
                        <li class="user-row" id='chat_user_2' data-user-id='2'>
                            <div class="user-img">
                                <a href="#"><img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-2.png" alt=""></a>
                            </div>
                            <div class="user-info">
                        ...
                        <li class="user-row" id='chat_user_3' data-user-id='3'>
                            <div class="user-img">
                                <a href="#"><img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-3.png" alt=""></a>
                            </div>
                            <div class="user-info">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="user-row" id='chat_user_4' data-user-id='4'>
                            <div class="user-img">
                                <a href="#"><img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-4.png" alt=""></a>
                            </div>
                            <div class="user-info">
                        ...
                        <li class="user-row" id='chat_user_5' data-user-id='5'>
                            <div class="user-img">
                                <a href="#"><img src="${pageContext.request.contextPath}/app/public/data/profile/avatar-5.png" alt=""></a>
                            </div>
                            <div class="user-info">
        ...
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/rickshaw-chart/js/Rickshaw.All.js"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/sparkline-chart/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/morris-chart/js/raphael-min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/morris-chart/js/morris.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/jvectormap/jquery-jvectormap-2.0.1.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        ...
        <script src="${pageContext.request.contextPath}/app/public/assets/js/dashboard.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
        ...
        <!-- Sidebar Graph - START --> 
        <script src="${pageContext.request.contextPath}/app/public/assets/plugins/sparkline-chart/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/app/public/assets/js/chart-sparkline.js" type="text/javascript"></script>
        <!-- Sidebar Graph - END --> 
