...
<div class="page-head">
	...
	<div class="bread-crumb pull-right">
		...
		<span class="divider">/</span> <a href="#" class="bread-current">Entidades
			Legales OM PAD Version Pendiente</a>
	</div>
									...
									<div class="pull-left">
										<ul class="list-inline">
											<li><i class="glyphicon glyphicon-th-list"></i>&nbsp;Entidades
												Legales OM PAD Pendientes de Activacion &nbsp;</li>
											<li>
												...
												<table cellpadding="0" cellspacing="0" border="0"
													...
													<thead>
														<tr style="font-weight: bold;">
															...
															<th class="centered">Pa�s Site</th>
...
<script
	src="${pageContext.request.contextPath}/app/public/js/app/service/rules/LegalEntityOmPADPendingService.js"></script>
...
<script>
	$(document).ready(function() {
		...
		LegalEntityOmPADPendingService.init();
