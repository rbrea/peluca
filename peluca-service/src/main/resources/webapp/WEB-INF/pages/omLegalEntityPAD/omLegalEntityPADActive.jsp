<div id="modalLegalEntytyOMPADVersion"
...
<div id="modalLegalEntytyOMPADVersionList"
...
<div id="modalOMPADActiveAuditedTable"
	class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg auditoria">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="panel panel-default" id="auditedResult">
					<div class="panel-body">
						<div class="container-fluid">
							<div class="table-responsive">
								<table class="table" id="auditedOMPADActiveTable">
									<thead>
										<tr>
											<th><h4>Id</h4></th>
									...
									<tbody id="auditedOMPADActiveTableBody">
...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i> <span>Entidades Legales OM PAD
			Activas</span>
	</h2>
...
<!-- Page heading ends -->
<div class="matter OM_LEGAL_ENTITY_PAD">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="container">
								...
								<div class="widget-head">
									...
									<div class="widget-icons pull-right">
										...
										<button id="btnBackToEdit"
											onclick="location.href='${pageContext.request.contextPath}/app/html/om-legal-entity-pad'"
...
<script
	src="${pageContext.request.contextPath}/app/public/js/app/service/rules/LegalEntityOmPADActiveService.js"></script>
...
<script>
	$(document).ready(function() {
		...
		LegalEntityOmPADActiveService.init();
...
<script id="rowOMPADAuditedSheet" type="text/x-handlebars-template">
