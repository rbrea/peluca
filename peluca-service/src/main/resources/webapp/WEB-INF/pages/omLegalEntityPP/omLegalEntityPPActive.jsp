			...
			<div class="modal-body">
				...
				<div class="panel panel-default" id="auditedResult">
					<div class="panel-body">
						<div class="container-fluid">
							<div class="table-responsive">
								<table class="table" id="auditedOMPPActiveTable">
									<thead>
										<tr>
											<th><h4>Id</h4></th>
									...
									<tbody id="auditedOMPPActiveTableBody">
...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i> <span>Entidades Legales OM PP Activas</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<!-- Divider -->
		<span class="divider">/</span> <a href="#" class="bread-current">Entidades Legales OM PP Activas</a>
	</div>
...
<!-- Page heading ends -->
<div class="matter OM_LEGAL_ENTITY_PP">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="container">
								...
								<div class="widget-head">
									<div class="pull-left">
										...
										<ul class="list-inline">
											<li>
												<i class="glyphicon glyphicon-th-list"></i>&nbsp;Entidades Legales Om PP Activas &nbsp;
											</li>
											<li>
											...
											<li>
												<button id="btnOMPPActiveRevisionAudited"
													class="btn btn-danger btn-sm roleable LECTURA" title="Auditoria">
													<i class="glyphicon glyphicon-eye-open"></i>
												</button>
											</li>
											<li>
												<button id="btnMigration" class="btn btn-warning btn-sm roleable APROBADOR" title="Enviar a Producci&oacute;n">
									...
									<div class="widget-icons pull-right">
										...
										<button  id ="btnBackToEdit" onclick="location.href='${pageContext.request.contextPath}/app/html/om-legal-entity-pp'" class="btn btn-warning btn-xs" title="Volver a Edicion">
												<i class="fa fa-reply-all"></i> ir a Edicion
										</button>
										
										<button  id ="btnBackToPending" onclick="location.href='${pageContext.request.contextPath}/app/html/om-legal-entity-pp-pending'" class="btn btn-info btn-xs" title="Volver a Edicion">
...
<script src="${pageContext.request.contextPath}/app/public/js/app/service/rules/LegalEntityOmPPActiveService.js"></script>
	...
	$(document).ready(
		function(){
			...
			$("#optOmLegalEntityPP").addClass("current");
	  		LegalEntityOmPPActiveService.init();
...
<script id="rowSellTypeUniqueVersionSheet" type="text/x-handlebars-template">
    ...
    {{#each this}}
     <tr data-report = {{id}} class=" centered">
		...
		<td class='centered'><h4>{{dto.afiliated_description}}</h4></td> 
...
<script id="rowOMPPActiveAuditedSheet" type="text/x-handlebars-template">
