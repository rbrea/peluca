    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Entidades Legales OM PP</h4>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Carga Masiva - Entidades Legales OM PP</h4>
            </div>
            <div class="modal-body">
                            ...
                            <div class="table-responsive">
                                <table class="table" id="ruleSellPointResultTable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="centered"><h4>Agencia Afiliada</h4></th>
    ...
    <div class="modal-dialog modal-lg auditoria">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Auditoria Entidades Legales OM PP</h4>
            </div>
            <div class="modal-body">
...
<!-- Page heading -->
<div class="page-head">
	<h2 class="pull-left OM_LEGAL_ENTITY_PP">
        <i class="fa fa-file-o"></i> Entidades Legales OM PP
    </h2>
                            ...
                            <div class="widget wgreen">
                                ...
                                <div class="widget-head">
                                    <div class="pull-left">
                                        ...
                                        <ul class="list-inline OM_LEGAL_ENTITY_PP">
                                            <li><i class="glyphicon glyphicon-search"></i>&nbsp;B&uacute;squeda
                                                de Entidades Legales OM PP
                                            </li>
                                    ...
                                    <div class="widget-icons pull-right">
                                        ...
                                        <button
                                                onclick="location.href='${pageContext.request.contextPath}/app/html/om-legal-entity-pp-pending'"
                                                class="btn btn-info btn-xs" title="Version Pendiente">
                                            <i class="fa fa-share"></i> ir a Pendiente de Activacion
                                        </button>

                                        <button
                                                onclick="location.href='${pageContext.request.contextPath}/app/html/om-legal-entity-pp-active'"
                                    ...
                                    <div class="padd">
                                        ...
                                        <form id="frmFilterRuleSellPoint" class="form-horizontal"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="control-label" for="filterLegalEntity">Entidad
                                                        Legal</label>
                                                    <div>
                                                        <select id="filterLegalEntity" class="form-control">
                                                            <option value="" selected>Seleccione una opci&oacute;n
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
...
<script
        src="${pageContext.request.contextPath}/app/public/js/app/service/rules/LegalEntityOmPPService.js"></script>
<script
        src="${pageContext.request.contextPath}/app/public/js/app/service/rules/LegalEntityOmPPUpload.js"></script>
<script
...
<script>
    $(document).ready(function () {
        ...
        $("#optOmLegalEntityPP").addClass("current");
        LegalEntityOmPPService.init();
        LegalEntityOmPPUpload.init();
...
<script id="rowSellTypeSheet" type="text/x-handlebars-template">
    ...
    <tr data-report={{id}} class=" centered">
        ...
        <td class="centered"><h4>{{om_legal_entyty_pp.product_type_description}}</h4></td>
        <td class="centered"><h4>{{om_legal_entyty_pp.country_code_site}}</h4></td>
        <td class="centered"><h4>{{om_legal_entyty_pp.afiliated_description}}</h4></td>
        <td class="centered"><h4>{{om_legal_entyty_pp.sell_type_description}}</h4></td>
        <td class="centered"><h4>{{om_legal_entyty_pp.legal_entity_description}}</h4></td>
...
<script id="rowSellTypeAuditedSheet" type="text/x-handlebars-template">
    ...
    <tr data-report="{{id}}" class=" centered">
        ...
        <td class='centered'>{{dto.afiliated_description}}</td>
