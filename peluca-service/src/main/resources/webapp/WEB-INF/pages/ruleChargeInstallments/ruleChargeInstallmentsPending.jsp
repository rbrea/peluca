...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i><span>Regla Cobranza por Cuotas Version Pendiente</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<!-- Divider -->
		<span class="divider">/</span> <a href="#" class="bread-current">Regla Cobranza por Cuotas Version Pendiente</a>
	</div>
								...
								<div class="widget-head">
									<div class="pull-left">
										<ul class="list-inline">
											<li>
												<i class="glyphicon glyphicon-th-list"></i>&nbsp;Regla Cobranza por Cuotas Pendientes de Activacion &nbsp;
											</li>
									...
									<div class="widget-icons pull-right">
										...
										<button  id ="btnGoToActive" onclick="location.href='${pageContext.request.contextPath}/app/html/rule-charge-active'" class="btn btn-success btn-xs" title="ir a Activa">
...
<script src="${pageContext.request.contextPath}/app/public/js/app/service/rules/RuleChargePendingService.js"></script>
