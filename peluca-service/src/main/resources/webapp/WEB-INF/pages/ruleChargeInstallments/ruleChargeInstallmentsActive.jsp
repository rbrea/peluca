<div id="modalRuleSellTypeVersion" class="modal fade bs-example-modal-lg" tabindex="-2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="modalRuleSellTypeVersionList" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div id="modalRuleChargeActiveAudited" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg auditoria">
		<div class="modal-content">
                  		<div class="modal-header">
                    		<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove"></i></button>
                  		...
                  		<div class="modal-body">
					   		...
					   		<div class="panel panel-default" id="auditedResult">
						            <div class="panel-body">     
						                <div class="container-fluid"> 
						               	 <div class="table-responsive">   
						                      <table class="table" id="auditedRuleChargeActiveTable">
						                          <thead>
						                            <tr>
						                            	<th class="centered"><h4>Id</h4></th>
						                          		<th class="centered"><h4>Revisi�n</h4></th>
						                            	<th class="centered"><h4>Usuario</h4></th>
						                            	<th class="centered"><h4>Tipo Revisi�n</h4></th>
						                            	<th class="centered"><h4>Fec Revisi�n</h4></th>
						                            	<th class="centered"><h4>Entidad Legal</h4></th>
						                              	...
						                              	<th class="centered"><h4>Version</h4></th>
						                            </tr>
						                          </thead>
						                          <tbody id ="auditedRuleChargeActiveTableBody">
...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i> <span> Regla Activa - Cobranza en Cuotas</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<!-- Divider -->
		<span class="divider">/</span> <a href="#" class="bread-current"> Regla - Cobranza en Cuotas  / Reglas Activas</a>
	</div>
							...
							<div class="widget wgreen">
								...
								<div class="widget-head">
									...
									<ul class="list-inline">
										<li>
											<i class="glyphicon glyphicon-th-list"></i>&nbsp;Cobranza en Cuotas Activas &nbsp;
										</li>
										<li>
										...
										<li>
											<button id="btnRuleChargeExport" class="btn btn-info btn-sm" title="Exportar">
										...
										<li>
											<button id="btnRevisionActiveAudited" class="btn btn-danger btn-sm roleable LECTURA" title="Auditoria">
									...
									<div class="widget-icons pull-right">
										...
										<button  id ="btnBackToEdit" onclick="location.href='${pageContext.request.contextPath}/app/html/rule-charge'" class="btn btn-warning btn-xs" title="Volver a Edicion">
												<i class="fa fa-reply-all"></i> ir a Edicion
										</button>
										
										<button  id ="btnBackToPending" onclick="location.href='${pageContext.request.contextPath}/app/html/rule-charge-pending'" class="btn btn-info btn-xs" title="Volver a Edicion">
...
<script src="${pageContext.request.contextPath}/app/public/js/app/service/rules/RuleChargeActiveService.js"></script>
...
<script id="rowRuleChargeAuditedActiveSheet" type="text/x-handlebars-template">
