...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i><span>Entidades Legales Tipo de
			Venta Version Pendiente</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<span class="divider">/</span> <a href="#" class="bread-current">Entidades
			Legales Tipo de Venta Version Pendiente</a>
	</div>
									...
									<div class="pull-left">
										<ul class="list-inline">
											<li><i class="glyphicon glyphicon-th-list"></i>&nbsp;Entidades
												Legales Tipo de Venta Pendientes de Activacion &nbsp;</li>
...
<script
	src="${pageContext.request.contextPath}/app/public/js/app/service/rules/SellTypePendingService.js"></script>
