	...
	<div class="modal-dialog modal-lg auditoria">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Auditoria Regla Puntos de Venta</h4>
			</div>
			<div class="modal-body">
...
<div class="page-head">
	<h2 class="pull-left" id="headerPageVersion">
		<i class="fa fa-file-o"></i> <span> Regla Activa- Tipos de
			Venta</span>
	</h2>
	...
	<div class="bread-crumb pull-right">
		...
		<span class="divider">/</span> <a href="#" class="bread-current">Regla
			- Tipos de Venta / Reglas Activas</a>
	</div>
								...
								<div class="widget-head">
									<div class="pull-left">
										...
										<ul class="list-inline">
											<li><i class="glyphicon glyphicon-th-list"></i>&nbsp;Tipos
												de Venta Activas &nbsp;</li>
											<li>
									...
									<div class="widget-icons pull-right">
										...
										<button id="btnBackToEdit"
											onclick="location.href='${pageContext.request.contextPath}/app/html/rule-sell-type'"
...
<script
	src="${pageContext.request.contextPath}/app/public/js/app/service/rules/SellTypeActiveService.js"></script>
<script
...
<script id="rowSellTypeUniqueVersionSheet"
    ...
    {{#each this}}
     <tr data-report = {{id}} class=" centered">
		<td class='centered'><h4>{{dto.channel_description}}</h4></td>
		...
		<td class='centered'><h4>{{dto.affiliated_agency_description}}</h4></td>
